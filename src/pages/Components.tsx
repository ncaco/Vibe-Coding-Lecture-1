...
import { Button, Card, Input, Badge, Icon, Carousel, Navbar, Hero, Footer } from '@/components';
...
const Components: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar Example */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Navbar 컴포넌트</h2>
        <div className="relative h-32 bg-gray-100 rounded-lg overflow-hidden">
          <Navbar transparent={false} />
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-gray-500">Navbar가 상단에 고정되어 있습니다</p>
          </div>
        </div>
      </div>
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Hero 컴포넌트</h2>
        <div className="space-y-8">
          {/* Default Hero */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">기본 Hero</h3>
            <Hero 
              title="당신의 꿈을 현실로 만드는 채용 서비스"
              subtitle="AI 기반 맞춤형 구인구직 매칭으로 최적의 기회를 찾아드려요"
              onPrimaryClick={() => alert('구인구직 시작하기 클릭!')}
              onSecondaryClick={() => alert('서비스 둘러보기 클릭!')}
            />
          </div>

          {/* Centered Hero */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">중앙 정렬 Hero</h3>
            <Hero 
              variant="centered"
              title="중앙 정렬된 Hero 섹션"
              subtitle="텍스트가 중앙에 정렬된 Hero 컴포넌트입니다"
          ...
          {/* Split Hero */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">분할 Hero</h3>
            <Hero 
              variant="split"
              title="분할 레이아웃 Hero"
              subtitle="텍스트와 시각적 요소가 나란히 배치된 Hero 컴포넌트입니다"
              primaryButtonText="지금 시작"
      ...
      {/* Carousel Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Carousel 컴포넌트</h2>
        <div className="space-y-8">
          {/* Basic Carousel */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">기본 Carousel</h3>
            <Carousel className="h-64 mx-4 sm:mx-6 lg:mx-8">
          ...
          {/* Image Carousel */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">이미지 Carousel</h3>
            <Carousel className="h-80 mx-4 sm:mx-6 lg:mx-8" interval={3000}>
              {sampleImages.map((image, index) => (
          ...
          {/* Manual Carousel */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">수동 Carousel (자동재생 비활성화)</h3>
            <Carousel autoPlay={false} className="h-48 mx-4 sm:mx-6 lg:mx-8">
      ...
      {/* Button Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Button 컴포넌트</h2>
        <Card variant="elevated" padding="lg" className="mx-4 sm:mx-6 lg:mx-8">
      ...
      {/* Card Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Card 컴포넌트</h2>
      ...
      {/* Input Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Input 컴포넌트</h2>
        <Card variant="elevated" padding="lg" className="mx-4 sm:mx-6 lg:mx-8">
          <div className="space-y-6">
            <div>
      ...
      {/* Badge Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Badge 컴포넌트</h2>
        <Card variant="elevated" padding="lg" className="mx-4 sm:mx-6 lg:mx-8">
          <div className="space-y-6">
            <div>
      ...
      {/* Icon Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Icon 컴포넌트</h2>
        <Card variant="elevated" padding="lg" className="mx-4 sm:mx-6 lg:mx-8">
          <div className="space-y-6">
            <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {[
                  ...
                  'menu', 'close', 'check', 'twitter', 'linkedin', 'facebook', 'instagram',
                  'mail', 'location'
                ].map((iconName) => (
      ...
      {/* Footer Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">Footer 컴포넌트</h2>
        <div className="space-y-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">기본 Footer</h3>
            <Footer />
          </div>
          
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 px-4 sm:px-6 lg:px-8">미니멀 Footer</h3>
      ...
      {/* Usage Examples */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 px-4 sm:px-6 lg:px-8">사용 예시</h2>
        <Card variant="elevated" padding="lg" className="mx-4 sm:mx-6 lg:mx-8">
          <div className="space-y-6">
            <div>
